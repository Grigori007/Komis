...
namespace Komis.Models
{
    ...
    public class MockCarRepository : ICarRepository
    {
        ...
        private void LoadCarsToList()
        {
            ...
            {
                new Car{CarId = 1, Mark="Toyota", Model="Corolla", ProductionDate=2000, Mileage="298000 km", EngineCapacity="1400 cm3", FuelType="Petrol", Power="80", Price=2850, ImageUrl="", MiniImageUrl="", IsCarOfTheWeek=true, CarDescription="Opis 1"},
