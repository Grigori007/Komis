    ...
    public class MockCarRepository : ICarRepository
    {
        ...
        private void LoadCarsToList()
        {
            _carsList = new List<Car>
            {
                ...
                new Car{CarId = 2, Mark="Bentley", Model="Continental Flying Spur", ProductionDate=2009, Mileage="65000", EngineCapacity="6000", FuelType="Petrol", Power="610", Price=239000, ImageUrl="", MiniImageUrl="", IsCarOfTheWeek=false},
